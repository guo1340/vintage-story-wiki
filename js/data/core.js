  ...
  "categories": [
    {
      ...
      "icon": "compass",
      "summary": "First-day priorities, beginner mistakes, early ages and survival order."
    },
    {
      "id": "survival",
      "title": "Survival",
      "icon": "campfire",
      "summary": "Hunger, body temperature, weather, temporal stability and winter readiness."
    },
    {
      "id": "crafting",
      "title": "Crafting",
      "icon": "tools",
      "summary": "Knapping, clay forming, storage, recipes and mechanical power."
    },
    {
      "id": "farming",
      "title": "Farming",
      "icon": "wheat",
      "summary": "Crops, animals, fruit trees, bees, cooking and preservation."
    },
    {
      "id": "smithing",
      "title": "Smithing",
      "icon": "anvil",
      "summary": "Metal progression, alloys, anvils, bloomery work, iron and steel."
    },
    {
      "id": "exploration",
      "title": "Exploration",
      "icon": "map",
      "summary": "Biomes, traders, ruins, caves, prospecting and temporal danger."
    },
    {
      "id": "creatures",
      "title": "Creatures",
      "icon": "shield",
      "summary": "Drifters, wildlife, weapons, armor, healing and combat habits."
    },
    {
      "id": "building",
      "title": "Building",
      "icon": "home",
      "summary": "Shelter, insulation, lighting, storage, cellars and decorative blocks."
    },
    {
      "id": "world-generation",
      "title": "World Generation",
      "icon": "globe",
      "summary": "Climate, ore abundance, caves, temporal settings and custom seeds."
    },
    {
      "id": "guides",
      "title": "Guides",
      "icon": "book",
      "summary": "High-value survival tutorials for winter, ores, windmills and progression."
    },
    {
      "id": "updates",
      "title": "Updates",
      "icon": "scroll",
      "summary": "Patch notes, version changes, upcoming features and developer news."
    },
    {
      "id": "mods",
      "title": "Mods",
      "icon": "gear",
      "summary": "Best mods, QoL mods, graphics mods, hardcore mods and installation."
    }
  ],
  "tips": [
